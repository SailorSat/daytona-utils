...
Private Function OpenProcessMemoryModel3() As Boolean
  ...
  'Supermodel.exe+432058  svn886 x64
  Result = NtWow64ReadVirtualMemory64(M3EM_Handle, M3EM_SupermodelEXE.lowpart + &H432058, M3EM_SupermodelEXE.highpart, M3EM_RAMBASE, 8, 0, liRet)
  If Result < 0 Then
    CloseProcess64
    Exit Function
...
Private Function CheckProfile() As Boolean
  ...
  'svn886 x64
  '"supermodel.exe"+00432060
  Dim Offset0 As LARGE_INTEGER, Offset1 As LARGE_INTEGER, Offset2 As LARGE_INTEGER, Offset3 As LARGE_INTEGER
  Result = NtWow64ReadVirtualMemory64(M3EM_Handle, M3EM_SupermodelEXE.lowpart + &H432060, M3EM_SupermodelEXE.highpart, Offset0, 8, 0, liRet)
  Result = NtWow64ReadVirtualMemory64(M3EM_Handle, Offset0.lowpart - &H1C0&, Offset0.highpart, Buffer(0), 8, 0, liRet)
