...
Private Sub cmdProfile_Click(Index As Integer)
  ...
  Select Case Index
    ...
    Case 42
      bsBuffer = StrConv("doubledash", vbFromUnicode)
  ...
  SendToClients sBuffer, CTRL_STATUS_OFFLINE, bMode
End Sub
...
Public Sub SendToClients(sBuffer As String, MinimumStatus As Byte, Optional Mode As Byte = 0)
  Dim Index As Integer
  Select Case Mode
    Case 0
      For Index = 0 To 16
